                           ...
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <div class="<?php echo $user['is_banned'] ? 'banned' : '';?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                ...
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="<?php echo $user['twitter'];?>" class="text-info fs-sm" target="_blank"><?php echo $user['twitter_name'];?></a>
                                    <a href="<?php echo $user['wrapbootstrap'];?>" class="text-info fs-sm" target="_blank" title="<?php echo $user['title'];?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                            <?php endforeach;?>
                            </div>
